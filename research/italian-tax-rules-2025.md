...
### Detrazioni per lavoro dipendente 2025 (Art. 13 TUIR modificato)
- Detrazione base per reddito ≤ €15.000: **€1.955** (era €1.880)
- **Trattamento integrativo aggiuntivo** (non tassabile) per redditi da lavoro dipendente ≤ €20.000:
...
- Lavoro autonomo / pensione: ≤ **€5.500** / **€8.000**
...
- Per collaboratori: 2/3 a carico del committente, 1/3 a carico del lavoratore

### C) Artigiani e Commercianti in Regime Forfettario
- Aliquota ordinaria: **24%** (23,70% se under 21)
- **Riduzione 35%** richiedibile per chi è in regime forfettario
- Contributo minimo commercianti 2025: ~**€4.549,70** (ridotto a ~€4.460,19 per under 21)
...
- **Chi:** Nati nel 2006 (diventati maggiorenni nel 2024), residenti in Italia
- **Requisito economico:** ISEE familiare ≤ **€35.000**
- **Importo:** **€500**

### Carta del Merito
- **Chi:** Chi ha sostenuto la maturità nel 2024 con voto **100/100** (entro 19 anni)
- **Importo:** **€500**
...
### Requisiti
- Residenza in Italia
- ISEE ≤ **€50.000** (in corso di validità)
...
## 5. Bonus Affitti Giovani 2025 (Detrazione IRPEF Under 31)

**Source:** [CAF Public](https://www.cafpublic.it/bonus-affitto-giovani-under-31-2025-requisiti-importo-e-modello-730) · [Agenzia delle Entrate Circolare n. 4/E 16-05-2025] · [PartitaIVA.it](https://www.partitaiva.it/bonus-affitto-giovani-2025-regole-ade/)  
...
### Come richiedere
Nel Modello 730/2025 → Quadro E → Rigo E71 con codice tipologia "4"

---

## 6. Dichiarazione dei Redditi 2025 (730 / Modello Redditi PF)
...
- Chi ha redditi da collaborazione coordinata e continuativa
- Non disponibile per partite IVA in regime ordinario (devono usare Redditi PF)

### Chi è obbligato a dichiarare
- Chi ha più fonti di reddito (es. due datori di lavoro)
- Chi supera la no-tax area e non ha sostituto d'imposta
- Chi ha redditi da affitto, capital gain, estero
- Chi vuole recuperare detrazioni (spese sanitarie, affitto, ecc.)
...
### Cos'è
Somma che il datore di lavoro accantona ogni anno per ogni dipendente. Equivale circa a **una mensilità lorda per anno lavorato**.

### Formula di calcolo
```
TFR annuale = Retribuzione lorda annua ÷ 13,5
```
*Esempio: RAL €24.000 → TFR accantonato/anno = €24.000 / 13,5 = **€1.777,78***

### Rivalutazione annuale
Il TFR accantonato viene rivalutato ogni anno con:
- **1,5% fisso** + **75% del tasso di inflazione ISTAT**

### Quando si riscuote
Il TFR è liquidato **alla cessazione del rapporto di lavoro**, per qualsiasi motivo:
...
Richiedibile se:
- Almeno **8 anni** di servizio nella stessa azienda
- Massimo **70%** del TFR maturato
- Solo una volta per rapporto
- Motivi validi: spese sanitarie documentate, acquisto prima casa (propria o dei figli), congedo parentale, formazione

### Scelta: TFR in azienda vs. fondo pensione
- Chi non sceglie entro 6 mesi dall'assunzione → TFR resta in azienda (o va al Fondo INPS per aziende >50 dipendenti)
- Chi opta per fondo pensione complementare → il TFR confluisce nel fondo

### Tassazione TFR alla liquidazione
- Non segue gli scaglioni IRPEF ordinari
- Si applica **tassazione separata** con aliquota media IRPEF calcolata sui redditi degli ultimi 5 anni
- L'Agenzia delle Entrate può ricalcolare la tassazione a posteriori
...
### Cos'è l'ISEE
Indicatore che misura la situazione economica del nucleo familiare, combinando reddito e patrimonio. Formula semplificata:
```
ISEE = (Reddito familiare + 20% Patrimonio) ÷ Scala di equivalenza
```
La scala di equivalenza parte da 1,00 (1 persona) e aumenta per ogni componente aggiuntivo.
...
## 9. Regime Forfettario Partita IVA 2025

**Source:** [Agenzia delle Entrate](https://www.agenziaentrate.gov.it/portale/schede/agevolazioni/regime-agevolato-forfettario/) · [bsness.com](https://www.bsness.com/business-plan/regime-forfettario-2025/) · [FattureInCloud](https://www.fattureincloud.it/guida-regime-forfettario/requisiti-di-accesso/)  
...
Il reddito non si calcola per differenza ricavi-costi, ma applicando un **coefficiente di redditività** per codice ATECO:

```
Reddito imponibile = Ricavi × Coefficiente ATECO
...
### Semplificazioni incluse
- Esenzione IVA (non si addebita, non si detrae)
- Niente ritenuta d'acconto sulle fatture
- Niente IRAP
- Contabilità semplificata (no registri IVA, no bilancio)
- Niente ISA/studi di settore

### Cause di esclusione principali
- Partecipazione in SRL o società di persone che svolgono attività analoga
- Redditi da lavoro dipendente/pensione > **€35.000** nell'anno precedente (soglia innalzata da €30.000 a €35.000 dalla Legge di Bilancio 2025)
- Spese per dipendenti/collaboratori > €20.000 lordi
- Attività svolta prevalentemente verso ex datori di lavoro (ultimi 2 anni)

### Contributi INPS in regime forfettario
- Artigiani/commercianti: aliquota ~24% con possibilità di **riduzione 35%** su domanda
- Professionisti senza cassa: Gestione Separata al **26,07%** (solo sul reddito, no minimale fisso)
...
**Source:** [Fenalca](https://www.fenalca.it/cedolare-secca-affitti-2025-nuove-aliquote-come-funziona-e-quanto-si-paga/) · [SoloAffittiPay](https://www.soloaffittipay.it/cedolare-secca-2025-sugli-affitti-aliquote-regole-e-novita)
...
**Scadenze pagamento cedolare secca:**
- Acconto (se > €257,52): due rate al 30 giugno + 30 novembre
- Saldo: 30 giugno anno successivo
- Codici tributo F24: 1840 (I rata acconto), 1841 (II rata/unica), 1842 (saldo)
...
## 11. Bonus Mobili 2025

**Source:** [Mansarda.it](https://www.mansarda.it/leggi-e-regolamenti/bonus-mobili-2025-senza-ristrutturazione-requisiti-e-funzionamento/) · [Brocardi.it](https://www.brocardi.it/notizie-giuridiche/bonus-mobili-2025-fino-euro-ogni-casa-mobili-elettrodomestici-ecco/5179.html)  
**Legal basis:** Art. 16, comma 2, TUIR
...
2. Acquistare mobili/elettrodomestici **entro il 31 dicembre 2025**
...
- **Elettrodomestici:** Classe energetica minima A per forni, E per lavatrici/lavastoviglie, F per frigo/congelatori
- Spese di trasporto e montaggio incluse
- **Non detraibili:** Porte, pavimenti, tende, complementi d'arredo

### Nota 2026
Secondo prime anticipazioni, il Bonus Mobili **non sarà prorogato al 2026**. Conviene agire entro il 31 dicembre 2025.
...
- Detrazioni per familiari a carico 2025 (riforma figli): Circolare AdE n. 4/E 16-05-2025
- Detrazioni spese sanitarie al 19% (no-cash dal 2020): Aggiornamento se superano €129,11 franchigia
- CCNL specifici per i tempi TFR: richiede ricerca per categoria lavorativa dell'utente
