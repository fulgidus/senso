...
```bash
node "/home/fulgidus/Documents/senso/.opencode/get-shit-done/bin/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "/home/fulgidus/Documents/senso/.opencode/get-shit-done/bin/gsd-tools.cjs" validate health
```
...
TASKS_DIR="/home/fulgidus/Documents/senso/.opencode/tasks"
if [ -d "$TASKS_DIR" ]; then
