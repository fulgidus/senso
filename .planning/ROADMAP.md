...
Plans:
- [ ] 12.1-01-PLAN.md - Auth fixes: 401-intercept in api-client + token renewal + redirect to login on expiry (#26, #27)
- [ ] 12.1-02-PLAN.md - Coach picker fixes: dark theme rendering + persona persistence across new conversation (#24, #25)
...
- [ ] 12.1-07-PLAN.md - Admin table UX: sort affordance + icon headers + pagination + localized category picker + settings save confirmation (#8, #9, #17, #18, #19, #20, #21)
