                    ...
                    {groups.map((group) => {
                        ...
                        return (
                            <div
                                ...
                                className={`rounded-xl border border-border bg-card px-4 py-3 transition-opacity ${isSuccess ? "opacity-40" : ""
                                    }`}
                            >
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex flex-col items-end gap-2 shrink-0">
                                        {/* Net amount */}
                                        <span
                                            className={`text-sm font-semibold ${group.netAmount >= 0 ? "text-green-600" : "text-foreground"
                                                }`}
                                        >
                                            {group.netAmount >= 0 ? "+" : ""}
