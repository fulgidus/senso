        ...
        >
            ...
            <div className="mb-6 flex gap-2 flex-wrap">
                ...
                <button
                    ...
                    className={`rounded-full px-4 py-1.5 text-sm font-medium ${activeTab === "charts"
                            ? "bg-primary text-primary-foreground"
                            : "text-muted-foreground hover:text-foreground"
                        }`}
                >
                ...
                <button
                    ...
                    className={`rounded-full px-4 py-1.5 text-sm font-medium ${activeTab === "files"
                            ? "bg-primary text-primary-foreground"
                            : "text-muted-foreground hover:text-foreground"
                        }`}
                >
                ...
                <button
                    ...
                    className={`rounded-full px-4 py-1.5 text-sm font-medium ${activeTab === "connectors"
                            ? "bg-primary text-primary-foreground"
                            : "text-muted-foreground hover:text-foreground"
                        }`}
                >
                        ...
                        <section id="income" className="rounded-2xl border border-border bg-card p-6">
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                ...
                                <div>
                                    ...
                                    <p
                                        className={`text-xl font-semibold ${(profile.monthlyMargin ?? 0) >= 0
                                                ? "text-primary"
                                                : "text-destructive"
                                            }`}
                                    >
