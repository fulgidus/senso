...
const TYPE_BADGE: Record<string, { bg: string; text: string }> = {
    ...
    slide_deck: { bg: "bg-green-100 dark:bg-green-900/40", text: "text-green-700 dark:text-green-300" },
    partner_offer: { bg: "bg-amber-100 dark:bg-amber-900/40", text: "text-amber-700 dark:text-amber-300" },
}
