                                    ...
                                    >
                                        {suggestions.map((s, index) => (
                                            <button
                                                ...
                                                className={`w-full flex items-center gap-2 px-4 py-2 text-sm text-left transition-colors ${selectedSuggestionIdx === index
                        ...
                        <div className="flex gap-1 overflow-x-auto">
                            {FILTER_TABS.map(({ key, i18nKey }) => (
                                <button
                                    ...
                                    className={`whitespace-nowrap rounded-full px-4 py-1.5 text-sm font-medium transition-colors ${filter === key
            ...
            <div className="mb-2 flex items-center gap-2">
                ...
                <div className="ml-auto flex gap-1">
                    {availableLocales.map((loc) => (
                        <span
                            key={loc}
                            className={`rounded px-1.5 py-0.5 text-[10px] font-medium uppercase ${loc === item.locale
                ...
                <div className="mt-auto flex flex-wrap gap-1 pt-2">
                    {item.topics.slice(0, 4).map((topic) => (
                        <button
                            ...
                            className={`rounded-md px-2 py-0.5 text-xs transition-colors ${activeTags.includes(topic)
