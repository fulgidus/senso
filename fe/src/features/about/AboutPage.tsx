...
export function AboutPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-6 py-10 space-y-8">
      ...
      <Link
        to="/about/deep"
        className="flex items-center justify-between rounded-2xl border border-primary/20 bg-primary/5 p-6 hover:bg-primary/10 transition-colors group"
      >
        <div>
          <h2 className="text-base font-semibold text-foreground">{t("about.deepLinkTitle")}</h2>
          <p className="text-sm text-muted-foreground">{t("about.deepLinkBody")}</p>
        </div>
