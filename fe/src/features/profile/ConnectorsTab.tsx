...
const BANKS = ["Intesa Sanpaolo", "UniCredit", "Fineco", "ING Italia", "N26", "Revolut"];
...
export function ConnectorsTab() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-xl font-semibold text-foreground">{t("connectors.title")}</h3>
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        {BANKS.map((bank) => (
          ...
          >
            ...
            <p className="text-sm font-medium text-foreground text-center">{bank}</p>
