...
import { createAdminMerchantApi, type ModerationLogAdminDTO } from "./adminMerchantApi";
              ...
              <tbody>
                {items.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-xs text-muted-foreground">{item.action_taken}</td>
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          onClick={() => void handleConfirm(item.id)}
