...
export const CCNL_PRESETS: CCNLPreset[] = [
  {
    ...
    overtimeOrdinaryMultiplier: 1.25,
    overtimeOrdinaryMaxWeekly: 2,
    overtimeExtraordinaryMultiplier: 1.5,
  ...
  },
  {
    ...
    extraMonths: 14,
    overtimeThresholdWeekly: 40,
    overtimeOrdinaryMultiplier: 1.3,
    overtimeOrdinaryMaxWeekly: 8,
    overtimeExtraordinaryMultiplier: 1.45,
    notes: "14ª in luglio.",
  },
  {
  ...
  },
  {
    ...
    extraMonths: 14,
    overtimeThresholdWeekly: 40,
    overtimeOrdinaryMultiplier: 1.28,
    overtimeOrdinaryMaxWeekly: 8,
    overtimeExtraordinaryMultiplier: 1.5,
    notes: "14ª in luglio.",
  },
  {
    ...
    label: "Bancario (ABI)",
    extraMonths: 14,
    overtimeThresholdWeekly: 37.5,
    overtimeOrdinaryMultiplier: 1.35,
    overtimeOrdinaryMaxWeekly: 6,
    overtimeExtraordinaryMultiplier: 1.5,
  ...
  },
  {
    ...
    extraMonths: 13,
    overtimeThresholdWeekly: 36,
    overtimeOrdinaryMultiplier: 1.15,
    overtimeOrdinaryMaxWeekly: 4,
    overtimeExtraordinaryMultiplier: 1.3,
  ...
  {
    id: "informatica_tlc",
    label: "Informatica / TLC privato (Assinform)",
    extraMonths: 14,
    overtimeThresholdWeekly: 40,
    overtimeOrdinaryMultiplier: 1.25,
    overtimeOrdinaryMaxWeekly: 8,
  ...
  },
  {
    ...
    label: "Turismo / Pubblici esercizi (FIPE)",
    extraMonths: 14,
    overtimeThresholdWeekly: 40,
    overtimeOrdinaryMultiplier: 1.3,
    overtimeOrdinaryMaxWeekly: 8,
  ...
  {
    id: "artigianato",
    label: "Artigianato (CNA/Confartigianato)",
    extraMonths: 13,
    overtimeThresholdWeekly: 40,
    overtimeOrdinaryMultiplier: 1.25,
    overtimeOrdinaryMaxWeekly: 8,
...
const PROD_BONUS_REDUCED_RATE = 0.1;
...
export async function getProfileStatus(token: string): Promise<CategorizationStatusResponse> {
...
export async function triggerCategorization(token: string): Promise<{ status: string }> {
  return apiRequest<{ status: string }>(API_BASE, "/profile/trigger-categorization", {
    method: "POST",
    token,
  });
}
...
export async function getUncategorized(token: string): Promise<UncategorizedTransactionDTO[]> {
...
export function createProfileApi(onUnauthorized?: () => Promise<string | null>) {
  return {
    ...
    dismissTimelineEvent: (token: string, eventId: string, reason: string, detail?: string) =>
    ...
    updateTransactionCategory: (token: string, transactionId: string, category: string) =>
      apiRequest<void>(API_BASE, `/profile/transactions/${transactionId}/category`, {
        method: "PATCH",
        token,
        body: { category },
        onUnauthorized,
    ...
    bulkUpdateCategoryByDescription: (token: string, description: string, category: string) =>
