      ...
      >
        ...
        <div className="flex flex-col gap-2 border-b border-border px-6 py-5">
          <div className="flex items-center gap-2">
            ...
            <h2 id="admin-gate-title" className="text-base font-semibold leading-tight">
              {t("adminHandleGate.title")}
            </h2>
          </div>
          <p id="admin-gate-desc" className="text-sm text-muted-foreground">
        ...
        <div className="flex flex-col gap-4 px-6 py-5">
          <div>
            <label htmlFor="admin-handle-input" className="sr-only">
            ...
            {/* Format hint */}
            <p className="mt-1 text-xs text-muted-foreground">{t("adminHandleGate.formatHint")}</p>
